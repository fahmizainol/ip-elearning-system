...
public class UploadAssignment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String title = request.getParameter("title");//Textbox value of name firstname.
            String course = request.getParameter("course");//Textbox value of name lastname.
...
//            System.out.println("Name: " + firstName);
            ...
            try{
              ...
              String sql = "INSERT INTO assignment(title, duedate, course, filename, path, added_date)values(?,?,?,?,?,?)";
              ...
              if (status > 0) {
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("/Lecturer_ViewAssignment.jsp");
